...
```{r echo=FALSE, warning=FALSE}
write.csv(round(cor(subset(construct_table9_data("^eq_"), select = c(TED, VIX, SENT, FEDFUNDS, INTERNET, ERM, EUROZONE, COVID, PC,Aggregate.Economic.Risk,Aggregate.Financial.Risk,Aggregate.Poliitical.Risk,liquidity,liquidity_bd,liquidity_rt))),4),"temp.csv")
```
